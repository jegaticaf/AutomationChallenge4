    ...
    try:
        ...
        for day in all_days:
            ...
            for movie in all_movies:
                ...
                movie_seat_types_list = [seat_type if seat_type != "" else seat_type for seat_type in movie_seat_types_split]
        ...
        print(movie_full_info_dict)
            ...
            log_message("Had a problem getting the single section information")
    finally:
        return movie_list